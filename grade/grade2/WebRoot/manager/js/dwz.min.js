...
$(":radio.radioboxCtrl", $p).radioboxCtrl($p);
...
//    $("#msg_button>ul").append("<li>aaaaa&nbsp;</li>");
} );
...
$('#msg_button button').click(function() {
    var trs = fnGetSelected(oTable),args={};
    trs.each(
        function(){
            var _args = DWZ.jsonEval($(this).attr("val"));
    ...
    $("input[name='display']").val(args['display']);
    $("input[name='value']").val(args['value']);
